// https://pixabay.com/api/?key={40863018-d3084d4a51e8d78d1c4f7dc14}
// key (required)	str	Your API key: 40863018-d3084d4a51e8d78d1c4f7dc14
...
async function fetchImages(name, page) {
  try {
    const response = await axios.get(
      `https://pixabay.com/api/?key=40863018-d3084d4a51e8d78d1c4f7dc14&q=${name}&image_type=photo&orientation=horizontal&safesearch=true&page=${page}&per_page=${perPage}`
    );
